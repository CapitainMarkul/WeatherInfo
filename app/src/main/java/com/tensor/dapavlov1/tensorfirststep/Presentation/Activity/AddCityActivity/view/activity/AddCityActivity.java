package com.tensor.dapavlov1.tensorfirststep.Presentation.Activity.AddCityActivity.view.activity;
...
import com.tensor.dapavlov1.tensorfirststep.PlacesAutoCompleteAdapter;
import com.tensor.dapavlov1.tensorfirststep.data.ViewModels.City;
import com.tensor.dapavlov1.tensorfirststep.data.ViewModels.Weather;
import com.tensor.dapavlov1.tensorfirststep.R;
import com.tensor.dapavlov1.tensorfirststep.SwitchGradient;
import com.tensor.dapavlov1.tensorfirststep.Presentation.AdaptersCommon.AdapterHorizontalWeather;
import com.tensor.dapavlov1.tensorfirststep.interfaces.AddCityPresenter;
import com.tensor.dapavlov1.tensorfirststep.Presentation.Activity.AddCityActivity.presenter.AddCityViewPresenter;
...
public class AddCityActivity extends MvpAppCompatActivity implements AddCityPresenter {
    @InjectPresenter
    AddCityViewPresenter addCityViewPresenter;
    ...
    private void setupViews() {
        ...
        cityName.setAdapter(new PlacesAutoCompleteAdapter(this, R.layout.item_list_auto_complete));
    }
    ...
    private void setupListeners() {
        ...
        cityName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                clearChecked();
                addCityViewPresenter.sendRequestGoogleApi(cityName.getText().toString());
            }
        });
    }
    ...
    void addToFavorite() {
        if (addToFavorite.isChecked()) {
            addCityViewPresenter.addToFavorite();
        } else {
            addCityViewPresenter.deleteFromFavorite();
        }
    }
    ...
    public void showInformation(City city) {
        if (addCityViewPresenter.isFavorite()) {
        ...
        rootContainer.setBackground(
                SwitchGradient.getIntent().getBackgroung(weatherNow.getIconCode()));
        // ??
    ...
    public void refreshWeathers(List<Weather> weathers) {
    ...
    private void showCard(CardView cardView) {
